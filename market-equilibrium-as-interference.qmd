...
@wager_experimenting_2020 provides a method for finding the optimal price level $p^*$ from the perspective of the market platform by experimentation. $p^*$ is the price at which the difference between overall revenue and payments to suppliers is maximized. In the paper's setup, the market consists of suppliers that can choose to become active on any given day, at which point they will be randomly allocated demand. On each day:
